...
This project scrapes song data from public Apple Music playlists, performs sentiment analysis using several different methods (VADER, TextBlob, and Transformer models), and reorders playlists from happiest to saddest songs. The project uses the Genius API to extract lyrics and provides visualizations of sentiment rankings.
...
The project includes a complete pipeline function that handles all steps from playlist URL to sentiment-ranked resul
...
#| results: true
try:
    fig.write_image("sentiment_ranking.png")
